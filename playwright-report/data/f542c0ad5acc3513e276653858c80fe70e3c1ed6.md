...
- Name: learningbox-catalog.spec.js >> Learningbox Catalog Acceptance Tests >> should render workbench sidebar and active learningbox dropdown
- Location: tests\e2e\learningbox-catalog.spec.js:13:3
...
Locator: locator('#workbench-tabs-bar')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#workbench-tabs-bar')
