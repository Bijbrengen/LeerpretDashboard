...
- Name: data-explorer.spec.js >> Data Explorer Acceptance Tests >> should render analytics filters and handle selection changes
- Location: tests\e2e\data-explorer.spec.js:47:3
...
Locator: locator('#analytics-leerbox')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#analytics-leerbox')
