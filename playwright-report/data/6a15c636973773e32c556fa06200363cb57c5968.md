...
- Name: dashboard-homepage.spec.js >> Dashboard Homepage Acceptance Tests >> should render SVG map on desktop viewport
- Location: tests\e2e\dashboard-homepage.spec.js:43:3
...
Locator: locator('.desktop-map-section')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.desktop-map-section')
