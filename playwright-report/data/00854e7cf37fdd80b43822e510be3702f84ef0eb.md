...
- Name: data-explorer.spec.js >> Data Explorer Acceptance Tests >> should render data subtool buttons (Brondata, Testdata, Rapportdata)
- Location: tests\e2e\data-explorer.spec.js:37:3
...
Locator: locator('button[data-type-tab="source"]')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('button[data-type-tab="source"]')
