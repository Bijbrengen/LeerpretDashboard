...
- Name: navigation-and-roles.spec.js >> Navigation and Role Routing Acceptance Tests >> should render page title and header status bar on homepage
- Location: tests\e2e\navigation-and-roles.spec.js:24:3
...
Expected pattern: /Leerpret Dashboard/
