...
- Name: service-and-calculator.spec.js >> Service & Calculator Acceptance Tests >> should switch input method dropdown
- Location: tests\e2e\service-and-calculator.spec.js:60:3
...
Locator: locator('#learner-input-method-select')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#learner-input-method-select')
