...
- Name: learningbox-catalog.spec.js >> Learningbox Catalog Acceptance Tests >> should toggle simulation source between data and ai
- Location: tests\e2e\learningbox-catalog.spec.js:34:3
...
Locator: locator('#test-source-data')
Expected: checked
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#test-source-data')
